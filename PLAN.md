...
- [x] Fix zone coverage test failures: OceanData overlaps with continents (Atlantic/South America, Atlantic/Africa, Atlantic/North America, Arctic/Asia) and uncovered gaps
